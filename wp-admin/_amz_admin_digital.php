...
function submitForm(){
    ...
    var request  = $.ajax({ 
      type: "POST",
      data: formdata, 
      url:"_amz_datas/digital_add.php"
...
<form id="myform" action="#" method="post" class="pure-form pure-form-stacked">
    <fieldset>
        <h1>AMAZONITE <small>Datacard <b>Digital</b> ( new )</small></h1>
...
<div class=" pure-g pure-control-group">
    <div class="pure-u-1-2">
            ...
            <input id="potentiel" name="potentiel" type="text" class="pure-input-2-3" placeholder="potentiel" required>
            <label >Repartition</label>
            <input id="repartition" name="repartition" type="text" class="pure-input-2-3" placeholder="repartition" required>
    </div>
    <div class="pure-u-1-2">
            ...
            <input id="mmc" name="mmc" type="text" class="pure-input-2-3" placeholder="mmc" required>
    </div>
    <div class="pure-u-1-2">
            <label class="pure-input-1-3">Origine</label>
            <input id="origine" name="origine" type="text" class="pure-input-2-3" placeholder="origine" required>
            <label class="pure-input-1-3">Thematique</label>
            <input id="thematique" name="thematique" type="text" class="pure-input-2-3" placeholder="thematique" required>
    </div>
...
<div class="pure-control-group">
  ...
  <input id="filebox" value="blank.png" name="file" type="hidden" class="pure-input-2-3" placeholder="filename">
